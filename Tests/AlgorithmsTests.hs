...
testeBuscarProjetoComDuplicataId =
    -- Assumindo que IDs únicos são garantidos, mas testando comportamento
...
executarTestesEspecialista4 = do
    ...
    putStrLn $ "Par/Ímpar: " ++ show testeMergeSortParImpar
    ...
    putStrLn $ "Último: " ++ show testeBuscarProjetoUltimo
    putStrLn $ "Meio: " ++ show testeBuscarProjetoMeio
    putStrLn $ "Tipo específico: " ++ show testeBuscarProjetoTipoEspecifico
    putStrLn $ "Status específico: " ++ show testeBuscarProjetoStatusEspecifico
    putStrLn $ "Orçamento: " ++ show testeBuscarProjetoOrcamento
    ...
    putStrLn $ "Início: " ++ show testeInserirOrdenadoInicio
    ...
    putStrLn "\n -- TESTES BUSCAR ÁRVORE --"
    putStrLn $ "Elemento existe: " ++ show testeBuscarArvoreElementoExiste
    putStrLn $ "Elemento não existe: " ++ show testeBuscarArvoreElementoNaoExiste
